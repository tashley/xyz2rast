...
# =========================================================
def rescaleXY(xyz, old_dx, new_dx, old_dy, new_dy):
...
# =========================================================
def genGrid(xmin, xmax, dx, ymin, ymax, dy):
...
# =========================================================
def gridXYZ(xyz, xgrid, ygrid, rSearch):
    """ Grids irregular xyz data """
    tree, ztree = kdtree(xyz) # Generate nearest neighbor search tree
    ny, nx = xgrid.shape
...
def grid_single(streamwise_oriented_xyz, nr, xmin, xmax, dx, ymin, ymax, dy):
    ...
    return gridXYZ(scaled_xyz, scaled_xgrid, scaled_ygrid, scaled_rsearch)
